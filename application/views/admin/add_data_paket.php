            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url() . 'add_data_paket/add_data_paket' ?>" method="post">
                                <div class="form-group row floating mb-2">
                                    <label for="nama" class="col-sm-2 col-form-label">Nama Paket :</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="nama" name="NamaPaket" placeholder="Nama Paket" required>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
                                    ...
                                    <div class="form-group row floating mb-2">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi1_jam_awal">
                                        </div>
                                    </div>
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Akhir :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi1_jam_akhir">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
                                    ...
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Awal :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi2_jam_awal">
                                        </div>
                                    </div>
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Akhir :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi2_jam_akhir">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
                                    ...
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Awal :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi3_jam_awal">
                                        </div>
                                    </div>
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Akhir :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi3_jam_akhir">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
                                    ...
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Awal :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi4_jam_awal">
                                        </div>
                                    </div>
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Akhir :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi4_jam_akhir">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
                                    ...
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Awal :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi5_jam_awal">
                                        </div>
                                    </div>
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Akhir :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi5_jam_akhir">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
                                    ...
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Awal :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi6_jam_awal">
                                        </div>
                                    </div>
                                    <div class="form-group row floating mb-2">
                                        <label for="nama" class="col-sm-2 col-form-label">Jam Akhir :</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control" id="data_awal" name="sesi6_jam_akhir">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row floating mb-2">
