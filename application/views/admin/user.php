            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="<?php echo base_url() . 'user' ?>">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="floating mb-3">
                        <a class="btn btn-success" href="<?php echo base_url() . 'add_data_user' ?>"><i class="fa-solid fa-plus"></i> Tambah Data User</a>
                    </div>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>edit_data_user/edit_data_user/<?php echo $id_user; ?>" class="btn btn-warning center">Edit</a>
                                                <a href="<?php echo base_url(); ?>user/hapus/<?php echo $id_user; ?>" class="btn btn-danger center">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
