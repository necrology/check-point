        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form action="<?php echo base_url() . 'data_jadwal/implementasi' ?>" id="form" class="form-horizontal" method="post">
                        <div class="form-body">
                    ...
                    <!-- <div class="floating mb-3">
                        <a class="btn btn-success" href="<?php echo base_url() . 'data_jadwal/paket_jadwal1' ?>">Paket Jadwal 1</a>
                        <a class="btn btn-success" href="<?php echo base_url() . 'data_jadwal' ?>">Paket Jadwal 2</a>
                    </div> -->
                    <div class="card mb-4">
